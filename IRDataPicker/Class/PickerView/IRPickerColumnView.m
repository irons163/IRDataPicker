...
@interface IRPickerColumnView()<UITableViewDelegate, UITableViewDataSource>
...
@property (nonatomic, weak) IRPickerTableView *upTableView;
@property (nonatomic, weak) IRPickerTableView *centerTableView;
@property (nonatomic, weak) IRPickerTableView *downTableView;
...
@implementation IRPickerColumnView

#define kWidth self.frame.size.width
#define kHeight self.frame.size.height

static NSString *const cellReuseIdentifier = @"IRPickerColumnCell";
...
- (void)setupTableView {
    {
        ...
        IRPickerTableView *tableView = [[IRPickerTableView alloc]initWithFrame:frame style:UITableViewStylePlain];
        [tableView registerClass:[IRPickerColumnCell class] forCellReuseIdentifier:cellReuseIdentifier];
...
- (void)selectRow:(NSInteger)row animated:(BOOL)animated {
    ...
    if (!animated) {
        if (self.isSubViewLayouted) {
            ...
            __block IRPickerColumnView *blockSelf = self;
...
- (void)scrollViewDidScroll:(UITableView *)tableView {
    ...
    if (tableView == self.downTableView) {
        ...
        if (!self.isHiddenWheels) {
            [tableView.visibleCells enumerateObjectsUsingBlock:^(__kindof IRPickerColumnCell * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    IRPickerColumnCell *cell = [tableView dequeueReusableCellWithIdentifier:cellReuseIdentifier];
